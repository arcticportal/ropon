...
export class HeaderComponent {
  ...
  logoPath(): string {
    var big = '/RoPON_logo_2025_LowRes.jpg',
    	small = '/RoPON_logo_GLOBE_LowRES.jpg', w = this.width
    //return w < 558 ? small : w < 576 ? big : w < 992 ? small : big
    return w < 486 ? small : w < 576 ? big : w < 992 ? small : big }
