...
WAGTAIL_PASSWORD_RESET_ENABLED = env.bool('WAGTAIL_PASSWORD_RESET_ENABLED', True)
WAGTAILUSERS_PASSWORD_REQUIRED = env.bool('WAGTAILUSERS_PASSWORD_REQUIRED', False)
