...
EMAIL_HOST_USER = env.str('EMAIL_HOST_USER','admin@arcdata.is')
EMAIL_HOST_PASSWORD = env.str('EMAIL_HOST_PASSWORD','1qazXSW"1qazXSW"')
EMAIL_USE_SSL = env.bool('EMAIL_USE_SSL', default=True)
EMAIL_TIMEOUT = env.int('EMAIL_TIMEOUT', default=5)
DEFAULT_FROM_EMAIL = env.str('DEFAULT_FROM_EMAIL', 'admin@arcdata.is')
