...
from .validators import validate_email_or_url
...
#     # ropon_id = models.CharField(max_length=255, unique=True, verbose_name='ROPO ID', help_text='Unique identifier for the observing network in the ROPO database.')

#     ropon_id = models.CharField(max_length=255, unique=True, verbose_name='ROPO ID', help_text='Unique identifier for the observing network in the ROPO database.', default=uuid.uuid4)
...
#     def status(self):
#         # Ensure status_string is not None
...
#     class Meta:
#         permissions = [
#             # ('submit_observingnetwork', 'Can submit observing network'),
#             ('publish_observingnetwork', 'Can publish observing network'),
#         ]
...
class ObservingNetworkPage(Page):
    name = models.CharField(max_length=255, verbose_name='Network Name', help_text='The full name of the observing network e.g. Svalbard Integrated Arctic Earth Observing System')
    network_owner = models.ForeignKey(
        User,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
